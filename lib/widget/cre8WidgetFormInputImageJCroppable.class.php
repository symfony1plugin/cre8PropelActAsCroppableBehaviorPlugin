...
/**
 * cre8WidgetFormInputFileInputImageJCroppable represents an upload HTML input tag which will
 * also display the uploaded image with the JCrop functionality.
 *
 * @see sfWidgetFormInputFileInputImageJCroppable from sfDoctrineJCroppablePlugin
 */
class cre8WidgetFormInputFileInputImageJCroppable extends sfWidgetFormInputFile
{
  /**
   * Constructor.
   *
